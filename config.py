...
class Config:
    ...
    LDAP_HOST = 'ldap://ritramagroup.local'
    ...
    LDAP_BIND_USER_DN = 'cn=au-zhangjay,ou=Users Account, ou=_Privileged, dc=ritramagroup, dc=local'  # set if binding requires a user

    # The password of Username to bind to LDAP
    LDAP_BIND_USER_PASSWORD = 'LoveChina.2024'
